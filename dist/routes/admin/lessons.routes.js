...
router.post('/:lessonId/resources', (0, auth_middleware_1.authenticate)(roles_1.ROLES.ADMIN), upload_1.resourceFileUpload.single('file'), resources_controller_1.addResource);
...
router.put('/:lessonId/resources/:resourceId', (0, auth_middleware_1.authenticate)(roles_1.ROLES.ADMIN), upload_1.resourceFileUpload.single('file'), resources_controller_1.updateResource);
